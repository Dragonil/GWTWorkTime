...
public class nAufgaben {
	...
	public static Panel getPanel() {
	   ...
	   static protected Aufgabe addRow() {
		   ...
		   neueAufgabe.setEndtDatum(DateTimeFormat.getFormat("yyyy-MM-dd HH:mm:ss").format(date.getValue()));
		   neueAufgabe.setPrio(prio.getSelectedIndex());
		   neueAufgabe.setStatus(0);
		   
		   if(WorkTime.eingeloggterUser != null){
			   neueAufgabe.setUserID(WorkTime.eingeloggterUser.getId());
		   }else{
			   neueAufgabe.setUserID(0);
		   }
